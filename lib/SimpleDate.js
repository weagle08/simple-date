 ...
 * @returns {number} - the days difference, +: this date is after or more recent, -: this date is in the past, 0: the dates are equal
 */
...
SimpleDate.prototype.toString = function(format){
    //TODO: come up w/ clever way to do this?
    if(format == 'MM/dd/yyyy') {
        return (this._month + 1) + '/' + this._date + '/' + this._year;
    } else if (format == 'dd/MM/yyyy') {
        return this._date + '/' + (this._month + 1) + '/' + this._year;
    } else if (format == 'MMMM dd, yyyy') {
        return this._monthNames[this._month] + ' ' + this._date + ', ' + this._year;
    } else if (format == 'dd MMMM, yyyy') {
        return this._date + ' ' + this._monthNames[this._month] + ', ' + this._year;
    } else if (format == 'MMM dd, yyyy') {
        return this._monthNamesShort[this._month] + ' ' + this._date + ', ' + this._year;
    } else if(format == 'MMM yyyy'){
        return this._monthNamesShort[this._month] + ' ' + this._year;
    } else {
